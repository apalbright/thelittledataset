...
> <details>
  ...
  *Are the effects of money bail on pretrial misconduct large enough to justify its costs? Money bail advocates argue that its usage is critical for averting misconduct, while skeptics counter that its effects are small and not worth the human costs of pretrial detention. I examine these tradeoffs using a program in Kentucky that eliminated financial bail (money bail or unsecured bail) for a subset of low-level cases. I use administrative data and a differences-in-differences approach to estimate the program’s effects on misconduct and detention. The program decreased the usage of financial bail by 50.5 p.p. and increased the rate of failure to appear by 3.3 p.p. The program’s effect on pretrial rearrest is indistinguishable from zero, and the data rules out even modest sized increases. Effects on misconduct are primarily driven by substitution away from money bail, rather than from unsecured bail, suggesting that threats of future fines may not effectively deter pretrial misconduct. The program also reduced hours in detention despite modest money bail requirements ($360 on average) in its absence, meaning that inability to put up even small bail amounts is an important constraint on release. Consistent with this interpretation, effects on release are larger in lower-income zip codes and among unemployed defendants. Taken together, the results suggest that one instance of misconduct needs to be at least 18 times as costly as one day in detention for money bail to justify its costs.*
</details> 
